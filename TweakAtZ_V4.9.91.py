...
class TweakAtZ(Script):
        ...
        return { 
            ...
            "settings": 
            {
                ...
                "c_behavior": 
                {
                    ...
                    "type": "enum",
                    "options": ["Keep value","Single Layer"],
                    "default": "Keep value",
                    "visible": True
                },
                "d_twLayers":
                {
                    ...
                    "visible": True,
                    "active_if": {"setting": "c_behavior", "value": "Keep value"}
                },
                "e1_Tweak_speed":
                {
                    "label": "Tw. Speed",
    ...
    def execute(self, data):
        ...
        TweakProp = {"speed": self._settings.getSettingByKey("e1_Tweak_speed").getValue(),
             "flowrate": self._settings.getSettingByKey("g1_Tweak_flowrate").getValue(),
             "flowrateOne": self._settings.getSettingByKey("g3_Tweak_flowrateOne").getValue(),
             "flowrateTwo": self._settings.getSettingByKey("g5_Tweak_flowrateTwo").getValue(),
             "bedTemp": self._settings.getSettingByKey("h1_Tweak_bedTemp").getValue(),
             "extruderOne": self._settings.getSettingByKey("i1_Tweak_extruderOne").getValue(),
             "extruderTwo": self._settings.getSettingByKey("i3_Tweak_extruderTwo").getValue(),
             "fanSpeed": self._settings.getSettingByKey("j1_Tweak_fanSpeed").getValue()}
        TweakPrintSpeed = self._settings.getSettingByKey("f1_Tweak_printspeed").getValue()
        TweakStrings = {"speed": "M220 S%f\n",
            ...
            "fanSpeed": "M106 S%d\n"}
        target_values = {"speed": self._settings.getSettingByKey("e2_speed").getValue(),
             "flowrate": self._settings.getSettingByKey("g2_flowrate").getValue(),
             "flowrateOne": self._settings.getSettingByKey("g4_flowrateOne").getValue(),
             "flowrateTwo": self._settings.getSettingByKey("g6_flowrateTwo").getValue(),
             "bedTemp": self._settings.getSettingByKey("h2_bedTemp").getValue(),
             "extruderOne": self._settings.getSettingByKey("i2_extruderOne").getValue(),
             "extruderTwo": self._settings.getSettingByKey("i4_extruderTwo").getValue(),
             "fanSpeed": self._settings.getSettingByKey("j2_fanSpeed").getValue()}
        old = {"speed": -1, "flowrate": -1, "flowrateOne": -1, "flowrateTwo": -1, "platformTemp": -1, "extruderOne": -1,
            "extruderTwo": -1, "fanSpeed": -1, "state": -1}
        twLayers = self._settings.getSettingByKey("d_twLayers").getValue()
        if self.getSettingByKey("c_behavior") == "Single Layer":
            behavior = 1
        else:
            behavior = 0
        try:
        ...
        if self.getSettingByKey("a_trigger") == "Layer No.":
            targetL_i = int(self.getSettingByKey("b_targetL").getValue())
            targetZ = 100000
        else:
            targetL_i = -100000
            targetZ = self.getSettingByKey("b_targetZ").getValue()
        index = 0
        for active_layer in data:
            ...
            for line in lines:
                ...
                if "M190" in line or "M140" in line and state < 3: #looking for bed temp, stops after target z is passed
                    old["bedTemp"] = getValue(line, "S", old["bedTemp"])
