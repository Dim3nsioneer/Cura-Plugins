...
##V5.1.1: Bugfix by Amedee Bulle for making it work again for sub-mm Z, Bugfix for compatibility issue with Griffin
...
class TweakAtZ(Script):
    ...
    def execute(self, data):
        ...
        if self.getSettingValueByKey("a_trigger") == "layer_no":
            ...
            targetZ = 100000
            #print("targetL: " + repr(targetL_i))
        else:
            targetL_i = -100000
            targetZ = self.getSettingValueByKey("b_targetZ")
            #print("targetZ: " + repr(targetZ))
        index = 0
        #lineno = 0
        for active_layer in data:
            ...
            for line in lines:
                ...
                if "G1" in line or "G0" in line:
                    ...
                    #print ("newZ: " + repr(newZ) + " at line no. " + repr(lineno) )
                    ...
                    if ((newZ != z) and (x is not None) and (y is not None)) or (newZ < z and layer == 0): #Griffin goes down in steps
                        z = newZ
